/**
 * @namespace CityArtWalks.Components.Artist.ArtistFiltersSkeleton
 * @version 1.0.0
...
/**
 * Artist Filters Skeleton Component
 *
 * Displays skeleton loading state for artist filters while data is being loaded
 ...
 */
export function ArtistFiltersSkeleton({ expanded = false }) {
  return (
