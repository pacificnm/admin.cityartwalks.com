/**
 * @namespace CityArtWalks.Components.Artist.ArtistTabMenu
 * @version 1.0.0
 * @author jaimie garner
 * @memberof CityArtWalks.Components.Artist
 * @description Responsive tab menu component that displays tabs on desktop and dropdown on mobile for artist views.
 */
...
/**
 * @memberof CityArtWalks.Components.Artist.ArtistTabMenu
 * @function ArtistTabMenu
 ...
 * @returns {JSX.Element} The rendered ArtistTabMenu component.
 *
 * @example
 * <ArtistTabMenu
 *   tabs={tabsWithCounts}
 ...
 * />
 */
export function ArtistTabMenu(props) {
...
/**
 * @memberof CityArtWalks.Components.Artist.ArtistTabMenu
 * PropTypes validation for the ArtistTabMenu component
 */
ArtistTabMenu.propTypes = {
