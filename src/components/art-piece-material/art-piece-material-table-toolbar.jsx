/**
 * @namespace CityArtWalks.Components.ArtPieceMaterial.ArtPieceMaterialTableToolbar
 * @version 1.0.0
...
/**
 * ArtPieceMaterial Table Toolbar Component
 *
 * Provides comprehensive filtering, searching, and action capabilities for the art piece material table.
 ...
 *
 * Features:
 * - Real-time search functionality for material names
 ...
 * @fileoverview Table toolbar component for art piece material filtering and actions
 * @author jaimie garner
 * @version 1.0.0
 *
...
/**
 * ArtPieceMaterial Table Toolbar component
 * Provides filtering, searching, and action capabilities for the art piece material table.
 *
 ...
 * @see {@link https://github.com/pacificnm/cityartwalks.com/wiki/Table-Filter-Results-Guidelines} - Table filtering guidelines
 */
export function ArtPieceMaterialTableToolbar({
  filters,
  onResetPage,
  onFilterChange,
  onSearchChange,
  ...
  const renderMenuActions = () => (
    ...
    >
      <MenuList>
        <MenuItem
          onClick={() => {
            // Handle print action for materials
            console.log('Print art piece materials');
            menuActions.onClose();
          }}
        >
          <PrintIcon />
        ...
        <MenuItem
          onClick={() => {
            // Handle import action for materials
            console.log('Import art piece materials');
            menuActions.onClose();
          }}
        >
        ...
        <MenuItem
          onClick={() => {
            // Handle export action for materials
            console.log('Export art piece materials');
            menuActions.onClose();
          }}
        >
        ...
        <MenuItem
          onClick={() => {
            ...
            console.log('Bulk status toggle for materials');
            menuActions.onClose();
          }}
        >
          <CheckCircleIcon />
        ...
        >
          ...
          {(!displayFilters || displayFilters.search) && (
            <TextField
              ...
              aria-label="Search art piece materials"
              InputProps={{
                startAdornment: (
