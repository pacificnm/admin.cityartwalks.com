/**
 * @file image-table-filter.jsx
 * @description Filter toolbar component for image table
...
/**
 * @description Filter toolbar component for image table with search, status, and featured filters
 * @memberof CityArtWalks.Components.Image
 * @function ImageTableFilter
 ...
 * @returns {JSX.Element} The Image Table Filter component.
 */
export function ImageTableFilter({
  searchTerm,
  onSearchChange,
  statusFilter,
  onStatusChange,
