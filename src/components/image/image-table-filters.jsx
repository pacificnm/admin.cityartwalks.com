...
export function ImageTableFilters({
  openDateRange,
  onCloseDateRange,
  onOpenDateRange,
  //
  ...
  const renderFilterType = (
    <>
      <Button
        ...
        endIcon={
          <Iconify
            icon={popover.open ? 'solar:arrow-up-bold' : 'solar:arrow-down-bold'}
            sx={{ ml: -0.5 }}
          />
        }
      >
  ...
  const renderFilterDate = (
    <>
      <Button
        ...
        endIcon={
          <Iconify
            icon={openDateRange ? 'solar:arrow-up-bold' : 'solar:arrow-down-bold'}
            sx={{ ml: -0.5 }}
          />
        }
      >
