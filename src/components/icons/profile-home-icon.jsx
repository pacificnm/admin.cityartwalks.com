/**
 * @namespace CityArtWalks.Components.Icons.ProfileHomeIcon
 * @version 1.0.0
 * @author jaimie garner
 * @memberof CityArtWalks.Components.Icons
 * @description Profile home icon component using Material-UI SvgIcon for user profile navigation.
 */

import SvgIcon from '@mui/material/SvgIcon';

/**
 * @memberof CityArtWalks.Components.Icons.ProfileHomeIcon
 * @function ProfileHomeIcon
 * @description Renders a profile home icon using the Material-UI SvgIcon component.
 * Commonly used for user profile navigation, account sections, and personal dashboard.
 *
 * @component
 * @param {Object} props - The component props.
 * @param {number} [props.size=24] - The size of the icon in pixels.
 * @param {Object} [props.sx={}] - Additional Material-UI sx styling props.
 * @returns {JSX.Element} The rendered ProfileHomeIcon component.
 *
 * @example
 * <ProfileHomeIcon size={16} />
 * <ProfileHomeIcon size={24} sx={{ color: 'primary.main' }} />
 */
export function ProfileHomeIcon({ size = 24, sx = {}, ...props }) {
  return (
