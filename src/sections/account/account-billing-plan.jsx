...
import { AddIcon, StarIcon } from 'src/components/icons';
  ...
  return (
    <>
          ...
          <Grid container spacing={{ xs: 0.5, md: 2 }}>
            ...
            <Grid size={{ xs: 12, md: 8 }}>
              <Button
                ...
                endIcon={<Iconify width={16} icon="solar:arrow-down-bold" />}
      ...
      <AddressListDialog
        ...
        action={
          <Button size="small" startIcon={<AddIcon />} sx={{ alignSelf: 'flex-end' }}>
            New
          </Button>
        }
      />
