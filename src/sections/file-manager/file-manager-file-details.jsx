...
import { AddIcon, StarIcon, DeleteIcon, StarOutlineIcon } from 'src/components/icons';
    ...
    <Stack spacing={1.5}>
      ...
      >
        ...
        <IconButton size="small" onClick={showProperties.onToggle}>
          <Iconify icon={showProperties.value ? 'solar:arrow-up-bold' : 'solar:arrow-down-bold'} />
        </IconButton>
      </Box>
    ...
    <Stack spacing={1.5}>
      ...
      >
        ...
        <IconButton size="small" onClick={showTags.onToggle}>
          <Iconify icon={showTags.value ? 'solar:arrow-up-bold' : 'solar:arrow-down-bold'} />
        </IconButton>
      </Box>
