  ...
  return (
    <Container sx={{ pt: { xs: 3, md: 5 }, pb: 10 }}>
      <Typography variant="h3" align="center" sx={{ mb: 2 }}>
        Discover the Art Around You
      </Typography>
      <Typography align="center" sx={{ color: 'text.secondary' }}>
        Unlock the full experience of City Art Walks with a premium membership. Explore curated
        walking tours, exclusive artist insights, and detailed guides to the most iconic and hidden
        art pieces in your city.
      </Typography>
