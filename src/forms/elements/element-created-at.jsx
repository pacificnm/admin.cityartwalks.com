/**
 * @fileoverview Generic created date element component for forms
 * @version 1.0.0
 ...
 * @function ElementCreatedAt
 * @description Generic created date display component for forms. Shows creation timestamp as a read-only
 * date-time picker with proper formatting and consistent styling across all forms.
 *
 * @param {Object} props - Component props
 * @param {string} [props.name="createdAt"] - Form field name for the created date
 * @param {string} [props.label="Created At"] - Display label for the field
 * @param {string} [props.helperText="System field - automatically set when record is created"] - Helper text explaining the field
 ...
 *
 * @returns {JSX.Element} The rendered created date element component
 *
 * @example
 ...
 *   helperText="When this record was first created"
 * />
 *
 * @see {@link https://github.com/pacificnm/cityartwalks.com/wiki/Forms} - Forms documentation
 */
export function ElementCreatedAt(props) {
  const {
    name = 'createdAt',
    label = 'Created At',
    helperText = 'System field - automatically set when record is created',
    disabled = true,
    sx,
    ...other
  } = props;
