/**
 * @namespace CityArtWalks.Forms.Elements.ArtPieceTitle
 * @version 1.0.0
 * @author Jaimie Garner
 * @fileoverview Form element for art piece title input with validation
 *
...
/**
 * @memberof CityArtWalks.Forms.Elements.ArtPieceTitle
 * @function ElementArtPieceTitle
 * @description Form element component for entering art piece titles with proper validation.
 *
 * This component provides a text input field specifically designed for art piece titles,
 ...
 * @param {string} [props.label="Art Piece Title"] - Label text for the input field
 ...
 *
 * @returns {JSX.Element} The rendered art piece title input element
 *
 * @example
 ...
 *   required
 *   helperText="Enter a descriptive title for the art piece"
 * />
 *
 * @see {@link https://github.com/pacificnm/cityartwalks.com/wiki/Forms} - Forms documentation
 * @see {@link https://github.com/pacificnm/cityartwalks.com/wiki/ArtPiece} - ArtPiece entity documentation
 */
export function ElementArtPieceTitle(props) {
  const {
    name = 'title',
...
ElementArtPieceTitle.propTypes = {
