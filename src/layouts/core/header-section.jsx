...
export function HeaderSection({
  ...
  return (
    ...
    >
      ...
      <HeaderContainer maxWidth={false} layoutQuery={layoutQuery} {...slotProps?.container}>
        {slots?.leftArea}
...
const HeaderRoot = styled(AppBar, {
  ...
  return {
    ...
    backgroundColor: 'rgba(255,255,255,0.7)', // <--- Add this line for translucency
    backdropFilter: 'blur(8px)', // Optional: adds a frosted glass effect
...
const HeaderContainer = styled(Container, {
  ...
  maxWidth: '100vw', // Prevents Container from limiting width
  paddingLeft: 0, // Optional: remove default Container padding
  paddingRight: 0, // Optional: remove default Container padding
