...
import { ArtPieceMaterialsHomeView } from 'src/sections/art-piece-materials/art-piece-materials-home-view';

/**
 * @memberof CityArtWalks.Pages.Dashboard.ArtPiece.ArtPieceMaterial
...
export const metadata = {
  title: `Dashboard - Art Piece - Art Piece Material - ${CONFIG.appName}`,
};
...
export default async function Page() {
  return <ArtPieceMaterialsHomeView />;
}
